...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 25 2017 г., 11:40
...
(1, 'admin', 'admin@pavel.com', 'admin', 'admin'),
(2, 'pavelodd', 'pavelodd@pavel.ru', 'odd', 'doubled'),
(3, 'berserk', 'berserk@pavel.ru', 'berserk', 'darksol'),
(4, 'kyden', 'kyden@pavel.ru', 'kyden', 'artyomka'),
(5, 'pavelzamana', 'topcoder@pavel.ru', 'pavel', 't3k9ru4j');
